...
public enum KingMessage {
    ...
    MESSAGE_11(R.string.lore_11_title, R.string.lore_11_body),
    MESSAGE_12(R.string.lore_12_title, R.string.lore_12_body),
    MESSAGE_13(R.string.lore_13_title, R.string.lore_13_body),
    MESSAGE_14(R.string.lore_14_title, R.string.lore_14_body),
    MESSAGE_15(R.string.lore_15_title, R.string.lore_15_body),
    MESSAGE_16(R.string.lore_16_title, R.string.lore_16_body),
    MESSAGE_17(R.string.lore_17_title, R.string.lore_17_body);
