...
public class Adept extends Adventurer {
    ...
    protected void configureStatistics() {
        ...
        this.imageId = R.drawable.unit_adept;
        this.idName = R.string.adventurer_adept_name;
        this.idDescription = R.string.adventurer_adept_description;
        ...
        this.nextClasses.add("FireWizard");
        this.nextClasses.add("DarkSorcerer");
    }
}
