...
public class Assassin extends Adventurer {
    ...
    protected void configureStatistics() {
        ...
        this.imageId = R.drawable.unit_assassin;
        this.idName = R.string.adventurer_assassin_name;
        this.idDescription = R.string.adventurer_assassin_description;
        this.passiveSkill = Skills.PASSIVE_INFILTRATOR;
        this.activeSkill = Skills.ACTIVE_BACKSTAB_III;
        ...
        this.nextClasses.add("SpireInitiate");
        this.nextClasses.add("RedStalker");
    }
}
