...
public class EsotericAlchemist extends Adventurer {
    ...
    protected void configureStatistics() {
        ...
        this.imageId = R.drawable.unit_esoteric_alchemist;
        this.idName = R.string.adventurer_esoteric_alchemist_name;
        this.idDescription = R.string.adventurer_esoteric_alchemist_description;
        this.passiveSkill = Skills.PASSIVE_THAUMATURGY_III;
        ...
        this.nextClasses.add("EldritchAlchemist");
    }
}
