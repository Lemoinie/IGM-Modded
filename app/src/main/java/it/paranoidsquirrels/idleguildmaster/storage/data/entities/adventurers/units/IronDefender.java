...
public class IronDefender extends Adventurer {
    ...
    protected void configureStatistics() {
        ...
        this.threat = 3;
        this.imageId = R.drawable.unit_iron_defender;
        this.idName = R.string.adventurer_iron_defender_name;
        this.idDescription = R.string.adventurer_iron_defender_description;
        ...
        this.nextClasses.add("Juggernaut");
    }
}
