...
public class SpireSage extends Adventurer {
    ...
    protected void configureStatistics() {
        ...
        this.imageId = R.drawable.unit_spire_sage;
        this.idName = R.string.adventurer_spire_sage_name;
        this.idDescription = R.string.adventurer_spire_sage_description;
