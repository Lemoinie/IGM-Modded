...
public class FireSlime extends Enemy {
    ...
    protected void configureStatistics() {
        ...
        this.imageId = R.drawable.unit_fire_slime;
        this.idName = R.string.enemy_fire_slime_name;
        this.idDescription = R.string.enemy_fire_slime_description;
        this.passiveSkill = Skills.PASSIVE_RED_HOT;
    ...
    public LinkedHashMap<ItemWrapper, Integer> listDrops(int i) {
        ...
        linkedHashMap.put(ItemWrapper.getInstance("SunfireCore", 1), Integer.valueOf(Logger.BARD_SHIELD));
