...
public class Gcss extends Enemy {
    ...
    protected void configureStatistics() {
        ...
        this.imageId = R.drawable.unit_gcss;
        this.idName = R.string.enemy_gcss_name;
        this.idDescription = R.string.enemy_gcss_description;
