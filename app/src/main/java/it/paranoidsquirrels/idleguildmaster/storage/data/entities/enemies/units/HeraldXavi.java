...
public class HeraldXavi extends Enemy {
    ...
    protected void configureStatistics() {
        ...
        this.imageId = R.drawable.unit_herald_xavi;
        this.idName = R.string.enemy_herald_xavi_name;
        this.idDescription = R.string.enemy_herald_xavi_description;
