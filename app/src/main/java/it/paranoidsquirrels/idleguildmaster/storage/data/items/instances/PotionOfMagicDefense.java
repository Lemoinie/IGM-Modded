...
public class PotionOfMagicDefense extends Potion {
    ...
    protected void configureProperties() {
        this.idName = R.string.consumable_potion_of_magic_defense_name;
        this.idDescription = R.string.consumable_potion_of_magic_defense_description;
        this.idImage = R.drawable.potion_of_magic_defense;
