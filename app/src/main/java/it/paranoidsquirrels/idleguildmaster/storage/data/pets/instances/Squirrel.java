...
public class Squirrel extends Wild {
    @Override // it.paranoidsquirrels.idleguildmaster.storage.data.pets.Pet
    protected void configureStatistics() {
        this.idImage = R.drawable.pet_squirrel;
        this.idName = R.string.pet_squirrel_name;
        this.idDescription = R.string.pet_squirrel_description;
