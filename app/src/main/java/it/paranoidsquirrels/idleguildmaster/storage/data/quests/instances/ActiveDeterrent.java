...
public class ActiveDeterrent extends Quest {
    ...
    protected void configure() {
        this.idName = R.string.quest_active_deterrent_name;
        this.idDescription = R.string.quest_active_deterrent_description;
