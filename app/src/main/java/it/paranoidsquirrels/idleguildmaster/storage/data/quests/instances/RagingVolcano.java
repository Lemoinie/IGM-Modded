...
public class RagingVolcano extends Quest {
    ...
    protected void configure() {
        this.idName = R.string.quest_raging_volcano_name;
        this.idDescription = R.string.quest_raging_volcano_description;
        this.defaultRarity = 4;
        this.minimumDifficulty = 11;
    }
