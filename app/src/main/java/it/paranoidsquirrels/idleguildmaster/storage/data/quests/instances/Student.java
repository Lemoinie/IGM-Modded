...
public class Student extends Quest {
    @Override // it.paranoidsquirrels.idleguildmaster.storage.data.quests.Quest
    public void calculateTargetProgress(int i) {
        this.targetProgress = i == 1 ? 1000L : (long) (Math.pow(1.5d, i - 1) * 5000.0d);
    }

    @Override // it.paranoidsquirrels.idleguildmaster.storage.data.quests.Quest
    protected void configure() {
        this.idName = R.string.quest_student_name;
        this.idDescription = R.string.quest_student_description;
