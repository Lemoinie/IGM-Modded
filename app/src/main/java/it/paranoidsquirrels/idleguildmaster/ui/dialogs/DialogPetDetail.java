...
public class DialogPetDetail extends CustomDialog {
    ...
    protected void initialize(Bundle bundle) {
        ...
        this.binding.ability1Name.setText(String.format(getString(R.string.pet_ability_name_unlocked), getString(this.pet.getPetAbility1().nameRes), Integer.valueOf(this.pet.getLevel())));
        this.binding.ability2Name.setText(this.pet.getLevel() > 20 ? String.format(getString(R.string.pet_ability_name_unlocked), getString(this.pet.getPetAbility2().nameRes), Integer.valueOf(this.pet.getLevel() - 20)) : String.format(getString(R.string.pet_ability_name_locked), getString(this.pet.getPetAbility2().nameRes), 21));
        this.binding.ability3Name.setText(this.pet.getLevel() > 40 ? String.format(getString(R.string.pet_ability_name_unlocked), getString(this.pet.getPetAbility3().nameRes), Integer.valueOf(this.pet.getLevel() - 40)) : String.format(getString(R.string.pet_ability_name_locked), getString(this.pet.getPetAbility3().nameRes), 41));
        this.binding.ability4Name.setText(this.pet.getLevel() > 60 ? String.format(getString(R.string.pet_ability_name_unlocked), getString(this.pet.getPetAbility4().nameRes), Integer.valueOf(this.pet.getLevel() - 60)) : String.format(getString(R.string.pet_ability_name_locked), getString(this.pet.getPetAbility4().nameRes), 61));
