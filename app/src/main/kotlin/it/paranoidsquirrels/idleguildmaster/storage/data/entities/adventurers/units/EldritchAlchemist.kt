...
class EldritchAlchemist : Adventurer() {
    override fun configureStatistics() {
        ...
        imageId = R.drawable.unit_eldritch_alchemist
        idName = R.string.adventurer_eldritch_alchemist_name
        idDescription = R.string.adventurer_eldritch_alchemist_description
        passiveSkill = Skills.PASSIVE_THAUMATURGY_IV
