...
class FireSlime : Enemy() {
    ...
    override fun configureStatistics() {
        ...
        imageId = R.drawable.unit_fire_slime
        idName = R.string.enemy_fire_slime_name
        idDescription = R.string.enemy_fire_slime_description
        passiveSkill = Skills.PASSIVE_RED_HOT
    ...
    override fun listDrops(i: Int): LinkedHashMap<ItemWrapper, Int> {
        ...
        linkedHashMap.put(ItemWrapper.getInstance("SunfireCore", 1), Logger.BARD_SHIELD)
