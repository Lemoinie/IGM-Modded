...
class HeraldShoran : Enemy() {
    ...
    override fun configureStatistics() {
        ...
        currentMana = 100
        imageId = R.drawable.unit_herald_shoran
        idName = R.string.enemy_herald_shoran_name
        idDescription = R.string.enemy_herald_shoran_description
    ...
    override fun listDrops(i: Int): LinkedHashMap<ItemWrapper, Int> {
        ...
        linkedHashMap.put(ItemWrapper.getInstance("SerpentBite", 1), 1000)
        return linkedHashMap
    }
    override fun calculateManaRegen(): Int = 0
}
