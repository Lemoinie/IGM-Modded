...
class HeraldXavi : Enemy() {
    ...
    override fun configureStatistics() {
        ...
        currentMana = 100
        imageId = R.drawable.unit_herald_xavi
        idName = R.string.enemy_herald_xavi_name
        idDescription = R.string.enemy_herald_xavi_description
    ...
    override fun listDrops(i: Int): LinkedHashMap<ItemWrapper, Int> {
        ...
        linkedHashMap.put(ItemWrapper.getInstance("SerpentLunge", 1), 1000)
