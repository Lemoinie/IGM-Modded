...
/**
 * Active era changelog - every v1.3.x release (current down to v1.3.0.0).
 *
 * This is the only changelog file developers edit when shipping a new mod update:
 * insert the new version entry at the TOP of [ENTRIES].
 *
